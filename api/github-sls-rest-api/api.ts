 ...
 *
 * The version of the OpenAPI document: 1.0.49-3
 * 
 *
...
export const IDPApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        assumeRoleForRepo: async (org: string, repo: string, role: string, provider?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        refreshOrgRepoConfig: async (org: string, repo: string, dryrun?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'org' is not null or undefined
...
export const IDPApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async assumeRoleForRepo(org: string, repo: string, role: string, provider?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiSamlResponseContainer>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.assumeRoleForRepo(org, repo, role, provider, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async refreshOrgRepoConfig(org: string, repo: string, dryrun?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiOrgRepoConfigRefreshResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.refreshOrgRepoConfig(org, repo, dryrun, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const IDPApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        assumeRoleForRepo(org: string, repo: string, role: string, provider?: string, options?: any): AxiosPromise<GithubSlsRestApiSamlResponseContainer> {
            return localVarFp.assumeRoleForRepo(org, repo, role, provider, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} org 
         ...
         * @throws {RequiredError}
         */
        refreshOrgRepoConfig(org: string, repo: string, dryrun?: boolean, options?: any): AxiosPromise<GithubSlsRestApiOrgRepoConfigRefreshResponse> {
            return localVarFp.refreshOrgRepoConfig(org, repo, dryrun, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} org 
...
export class IDPApi extends BaseAPI {
     ...
     * @memberof IDPApi
     */
    public assumeRoleForRepo(org: string, repo: string, role: string, provider?: string, options?: AxiosRequestConfig) {
        return IDPApiFp(this.configuration).assumeRoleForRepo(org, repo, role, provider, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof IDPApi
     */
    public refreshOrgRepoConfig(org: string, repo: string, dryrun?: boolean, options?: AxiosRequestConfig) {
        return IDPApiFp(this.configuration).refreshOrgRepoConfig(org, repo, dryrun, options).then((request) => request(this.axios, this.basePath));
    }
