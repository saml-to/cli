 ...
 *
 * The version of the OpenAPI document: 1.0.105-36
 * 
 *
 ...
 * 
 * @export
 * @interface GithubSlsRestApiCallbackRequest
 */
export interface GithubSlsRestApiCallbackRequest {
    /**
     * 
     * @type {string}
     * @memberof GithubSlsRestApiCallbackRequest
     */
    'state': string;
    /**
     * 
 ...
 * 
 * @export
 * @interface GithubSlsRestApiCallbackResponse
 */
export interface GithubSlsRestApiCallbackResponse {
    /**
     * 
     * @type {string}
     * @memberof GithubSlsRestApiCallbackResponse
     */
    'token': string;
}
/**
...
/**
 * Short-lived, S3-compatible credentials for a Cloudflare R2 bucket. Present on a SamlResponseContainer when the provider is `type: cloudflare-r2`.
 * @export
 * @interface GithubSlsRestApiCloudflareR2SdkOptions
 */
export interface GithubSlsRestApiCloudflareR2SdkOptions {
    /**
     * ISO-8601
     * @type {string}
     * @memberof GithubSlsRestApiCloudflareR2SdkOptions
     */
    'expiration': string;
    /**
     * 
     ...
     * @memberof GithubSlsRestApiCloudflareR2SdkOptions
     */
    'region': GithubSlsRestApiCloudflareR2SdkOptionsRegionEnum;
    /**
     * 
     * @type {string}
     * @memberof GithubSlsRestApiCloudflareR2SdkOptions
...
/**
    ...
    * @enum {string}
    */
export enum GithubSlsRestApiCloudflareR2SdkOptionsRegionEnum {
    Auto = 'auto'
}
...
export enum GithubSlsRestApiCredentialIssueAuditTypeV1 {
...
/**
 * `saml` (default): the provider is a SAML Service Provider (entityId + acsUrl). `cloudflare-r2`: the provider is a Cloudflare account; roles are R2 buckets and assumption yields short-lived S3-compatible credentials instead of a SAML Response.
 * @export
 * @enum {string}
 */

export enum GithubSlsRestApiProviderTypeV1 {
    Saml = 'saml',
...
export interface GithubSlsRestApiProviderV1 {
    /**
     * Seconds, as a string (like the AWS SessionDuration attribute). Default 3600, max 604800
     * @type {string}
     * @memberof GithubSlsRestApiProviderV1
     */
    'sessionDuration'?: string;
    /**
     * Name of a secret delivered by config-sync-action holding the R2 API token value
     * @type {string}
     * @memberof GithubSlsRestApiProviderV1
     */
    'secretRef'?: string;
    ...
    /**
     * 
     * @type {GithubSlsRestApiR2JurisdictionV1}
     * @memberof GithubSlsRestApiProviderV1
     */
    'jurisdiction'?: GithubSlsRestApiR2JurisdictionV1;
    /**
     * 
     * @type {string}
     * @memberof GithubSlsRestApiProviderV1
    ...
    /**
     * 
     * @type {GithubSlsRestApiProviderTypeV1}
     * @memberof GithubSlsRestApiProviderV1
     */
    'type'?: GithubSlsRestApiProviderTypeV1;
}
...
export enum GithubSlsRestApiR2JurisdictionV1 {
    Default = 'default',
    Eu = 'eu',
    Fedramp = 'fedramp'
}
...
export enum GithubSlsRestApiR2PermissionV1 {
...
export interface GithubSlsRestApiRolesV1 {
    ...
    /**
     * 
     * @type {GithubSlsRestApiR2PermissionV1}
     * @memberof GithubSlsRestApiRolesV1
     */
    'permission'?: GithubSlsRestApiR2PermissionV1;
    /**
     * 
     * @type {boolean}
     * @memberof GithubSlsRestApiRolesV1
...
export interface GithubSlsRestApiSamlResponseContainer {
    /**
     * 
     * @type {GithubSlsRestApiCloudflareR2SdkOptions}
     * @memberof GithubSlsRestApiSamlResponseContainer
     */
    'cloudflareR2'?: GithubSlsRestApiCloudflareR2SdkOptions;
    /**
     * 
     * @type {GithubSlsRestApiChallenge}
     * @memberof GithubSlsRestApiSamlResponseContainer
 ...
 * 
 * @export
 * @interface GithubSlsRestApiSecretsResponse
 */
export interface GithubSlsRestApiSecretsResponse {
    /**
     * 
     * @type {Array<string>}
     * @memberof GithubSlsRestApiSecretsResponse
     */
    'names': Array<string>;
    /**
     * 
 ...
 * 
 * @export
 * @interface GithubSlsRestApiSetSecretsRequest
 */
export interface GithubSlsRestApiSetSecretsRequest {
    /**
     * 
     * @type {string}
     * @memberof GithubSlsRestApiSetSecretsRequest
     */
    'commitSha'?: string;
    /**
     * name → value. Names match ^[A-Z][A-Z0-9_]{0,63}$
     * @type {{ [key: string]: string; }}
     * @memberof GithubSlsRestApiSetSecretsRequest
     */
...
/**
 * GitHubOauthApi - axios parameter creator
 * @export
 */
export const GitHubOauthApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @param {GithubSlsRestApiCallbackRequest} githubSlsRestApiCallbackRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        oauthCallback: async (githubSlsRestApiCallbackRequest: GithubSlsRestApiCallbackRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'githubSlsRestApiCallbackRequest' is not null or undefined
            assertParamExists('oauthCallback', 'githubSlsRestApiCallbackRequest', githubSlsRestApiCallbackRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(githubSlsRestApiCallbackRequest, localVarRequestOptions, configuration)
...
/**
 * GitHubOauthApi - functional programming interface
 * @export
 */
export const GitHubOauthApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = GitHubOauthApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @param {GithubSlsRestApiCallbackRequest} githubSlsRestApiCallbackRequest 
         ...
         * @throws {RequiredError}
         */
        async oauthCallback(githubSlsRestApiCallbackRequest: GithubSlsRestApiCallbackRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiCallbackResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.oauthCallback(githubSlsRestApiCallbackRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * GitHubOauthApi - factory interface
 * @export
 */
export const GitHubOauthApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = GitHubOauthApiFp(configuration)
    return {
        /**
         * 
         * @param {GithubSlsRestApiCallbackRequest} githubSlsRestApiCallbackRequest 
         ...
         * @throws {RequiredError}
         */
        oauthCallback(githubSlsRestApiCallbackRequest: GithubSlsRestApiCallbackRequest, options?: any): AxiosPromise<GithubSlsRestApiCallbackResponse> {
            return localVarFp.oauthCallback(githubSlsRestApiCallbackRequest, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * GitHubOauthApi - object-oriented interface
 * @export
 * @class GitHubOauthApi
 * @extends {BaseAPI}
 */
export class GitHubOauthApi extends BaseAPI {
    /**
     * 
     * @param {GithubSlsRestApiCallbackRequest} githubSlsRestApiCallbackRequest 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof GitHubOauthApi
     */
    public oauthCallback(githubSlsRestApiCallbackRequest: GithubSlsRestApiCallbackRequest, options?: AxiosRequestConfig) {
        return GitHubOauthApiFp(this.configuration).oauthCallback(githubSlsRestApiCallbackRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const IDPApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteOrgRepoSecret: async (org: string, repo: string, name: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'org' is not null or undefined
            assertParamExists('deleteOrgRepoSecret', 'org', org)
            // verify required parameter 'repo' is not null or undefined
            assertParamExists('deleteOrgRepoSecret', 'repo', repo)
            // verify required parameter 'name' is not null or undefined
            assertParamExists('deleteOrgRepoSecret', 'name', name)
            const localVarPath = `/api/v1/idp/orgs/{org}/repos/{repo}/secrets/{name}`
                .replace(`{${"org"}}`, encodeURIComponent(String(org)))
                .replace(`{${"repo"}}`, encodeURIComponent(String(repo)))
        ...
        /**
         * Store named secrets for the repository holding saml-to.yml (e.g. a Cloudflare R2 token referenced by `providers.<key>.secretRef`). Only that repository\'s own GitHub Actions token (a `ghs_` installation token) may call this. Values are never returned or logged.
         * @param {string} org 
         * @param {string} repo 
         * @param {GithubSlsRestApiSetSecretsRequest} githubSlsRestApiSetSecretsRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        setOrgRepoSecrets: async (org: string, repo: string, githubSlsRestApiSetSecretsRequest: GithubSlsRestApiSetSecretsRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'org' is not null or undefined
            assertParamExists('setOrgRepoSecrets', 'org', org)
            // verify required parameter 'repo' is not null or undefined
            assertParamExists('setOrgRepoSecrets', 'repo', repo)
            // verify required parameter 'githubSlsRestApiSetSecretsRequest' is not null or undefined
            assertParamExists('setOrgRepoSecrets', 'githubSlsRestApiSetSecretsRequest', githubSlsRestApiSetSecretsRequest)
            const localVarPath = `/api/v1/idp/orgs/{org}/repos/{repo}/secrets`
                .replace(`{${"org"}}`, encodeURIComponent(String(org)))
                .replace(`{${"repo"}}`, encodeURIComponent(String(repo)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(githubSlsRestApiSetSecretsRequest, localVarRequestOptions, configuration)
...
export const IDPApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteOrgRepoSecret(org: string, repo: string, name: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiSecretsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteOrgRepoSecret(org, repo, name, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async setOrgRepoSecrets(org: string, repo: string, githubSlsRestApiSetSecretsRequest: GithubSlsRestApiSetSecretsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiSecretsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.setOrgRepoSecrets(org, repo, githubSlsRestApiSetSecretsRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const IDPApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteOrgRepoSecret(org: string, repo: string, name: string, options?: any): AxiosPromise<GithubSlsRestApiSecretsResponse> {
            return localVarFp.deleteOrgRepoSecret(org, repo, name, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} org 
         ...
         * @throws {RequiredError}
         */
        setOrgRepoSecrets(org: string, repo: string, githubSlsRestApiSetSecretsRequest: GithubSlsRestApiSetSecretsRequest, options?: any): AxiosPromise<GithubSlsRestApiSecretsResponse> {
            return localVarFp.setOrgRepoSecrets(org, repo, githubSlsRestApiSetSecretsRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class IDPApi extends BaseAPI {
     ...
     * @memberof IDPApi
     */
    public deleteOrgRepoSecret(org: string, repo: string, name: string, options?: AxiosRequestConfig) {
        return IDPApiFp(this.configuration).deleteOrgRepoSecret(org, repo, name, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof IDPApi
     */
    public setOrgRepoSecrets(org: string, repo: string, githubSlsRestApiSetSecretsRequest: GithubSlsRestApiSetSecretsRequest, options?: AxiosRequestConfig) {
        return IDPApiFp(this.configuration).setOrgRepoSecrets(org, repo, githubSlsRestApiSetSecretsRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
