 ...
 *
 * The version of the OpenAPI document: 1.0.63-6
 * 
 *
...
export const IDPApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getCloudformationUrl: async (org: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'org' is not null or undefined
            assertParamExists('getCloudformationUrl', 'org', org)
            const localVarPath = `/api/v1/idp/orgs/{org}/cloudformation`
                .replace(`{${"org"}}`, encodeURIComponent(String(org)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const IDPApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getCloudformationUrl(org: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiCloudformationResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCloudformationUrl(org, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const IDPApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getCloudformationUrl(org: string, options?: any): AxiosPromise<GithubSlsRestApiCloudformationResponse> {
            return localVarFp.getCloudformationUrl(org, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
...
export class IDPApi extends BaseAPI {
     ...
     * @memberof IDPApi
     */
    public getCloudformationUrl(org: string, options?: AxiosRequestConfig) {
        return IDPApiFp(this.configuration).getCloudformationUrl(org, options).then((request) => request(this.axios, this.basePath));
    }
