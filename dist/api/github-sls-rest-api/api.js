...
const IDPApiAxiosParamCreator = function (configuration) {
    return {
        ...
        assumeRole: async (role, org, provider, options = {}) => {
            ...
            const localVarPath = `/api/v1/idp/roles/{role}/assume-role`
         ...
         * @throws {RequiredError}
         */
        listRoles: async (org, refresh, options = {}) => {
...
const IDPApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listRoles(org, refresh, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listRoles(org, refresh, options);
            return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
        },
        /**
         *
...
const IDPApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listRoles(org, refresh, options) {
            return localVarFp.listRoles(org, refresh, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @param {string} provider
...
class IDPApi extends base_1.BaseAPI {
     ...
     */
    listRoles(org, refresh, options) {
        return (0, exports.IDPApiFp)(this.configuration).listRoles(org, refresh, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @param {string} provider
