...
`);
      ...
      .command({
        ...
        describe:
          'Add providers or permissions to the configuration (use `add --help` for more detail)',
      ...
      .command({
        command: 'assume [role]',
        describe:
          'Assume a role. Use the `show roles` command to show available roles (use `assume --help` for more detail)',
